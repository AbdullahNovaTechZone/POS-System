package com.novatechzone.pos.domain.security.filter;

import com.novatechzone.pos.domain.owner.OwnerService;
import com.novatechzone.pos.domain.security.domain.OwnerMapper;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        ...
        UserDetails userDetails = mapper.mapToOwnerDetails(owner);
